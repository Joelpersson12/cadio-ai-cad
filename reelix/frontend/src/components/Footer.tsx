    ...
    <footer className="border-t border-white/8 mt-24 py-12 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-start justify-between gap-8">
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-bold text-sm text-white">Reelix</span>
            </div>
            <p className="text-white/40 text-xs max-w-xs leading-relaxed">
              AI ad videos in seconds. Generate copy, compose visuals, and create scroll-stopping video ads for any product — no editing skills required.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 text-xs">
            ...
            <div>
              ...
              <div className="space-y-2">
                <a href="#" className="block text-white/35 hover:text-white/70 transition-colors">About</a>
        ...
        <div className="mt-10 pt-6 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-3">
          <p className="text-white/20 text-xs">© 2026 Reelix. All rights reserved.</p>
