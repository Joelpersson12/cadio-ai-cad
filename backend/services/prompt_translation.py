...
_PHRASE_TRANSLATIONS: tuple[tuple[str, str], ...] = (
    ...
    (r"\b(?:garderob(?:en)?|klad\s*garderob(?:en)?|kladgarderob(?:en)?|skap(?:et)?|klad\s*skap(?:et)?|kladskap(?:et)?)\b", "wardrobe"),
    (r"\b(?:garage(?:t)?|garaget|verkstad(?:en)?|workshop)\b", "garage"),
    (r"\b(?:cykel(?:n)?|mountainbike|mtb|bike|bicycle)\b", "bicycle"),
    ...
    (r"\b(?:klad\s*hangare|kladhangare|klades\s*hangare|kladeshangare|jack\s*hangare|jackhangare|rock\s*hangare|rockhangare)\b", "clothes hanger"),
    (r"\b(?:baltes\s*hallaren?|balteshallaren?|skarp\s*hallaren?|skarphallaren?)\b", "belt holder"),
    (r"\b(?:hjalm\s*hallaren?|hjalmhallaren?|hjalm\s*hangare|hjalmhangare)\b", "helmet holder"),
    ...
    (r"\b(?:soporte\s+(?:de\s+|para\s+)?bater[ií]a|porta\s*bater[ií]a)\b", "battery holder"),
    (r"\b(?:montaje\s+(?:de\s+|para\s+)?bater[ií]a|soporte\s+de\s+pared\s+(?:de\s+|para\s+)?bater[ií]a)\b", "battery wall mount"),
    ...
    (r"\b(?:support\s+(?:de\s+|pour\s+)?batterie|porte\s*batterie)\b", "battery holder"),
    ...
    (r"\b(?:supporto\s+(?:per\s+)?batteria|porta\s*batteria)\b", "battery holder"),
    ...
    (r"\b(?:akku\s*halter|akkuhalter|batterie\s*halter|batteriehalter)\b", "battery holder"),
    (r"\b(?:akku\s*wandhalter|akkuwandhalter|batterie\s*wandhalter|batteriewandhalter)\b", "battery wall mount"),
    ...
    (r"\b(?:suporte\s+(?:de\s+|para\s+)?bateria|porta\s*bateria)\b", "battery holder"),
...
_WORD_TRANSLATIONS: dict[str, str] = {
    ...
    "balten": "belts",
    "baltes": "belt",
    "balteshallare": "belt holder",
    "chainguide": "chain guide",
    "cross": "dirtbike",
    "crosshoj": "dirtbike",
    "cykel": "bicycle",
    "cykeln": "bicycle",
    "cykelhallare": "bicycle holder",
    "cykelstyre": "handlebar",
    "del": "part",
    "delar": "parts",
    "djup": "depth",
    "duplicera": "duplicate",
    ...
    "hjalm": "helmet",
    "hjalmar": "helmets",
    "hjalmhallare": "helmet holder",
    "hjalmhangare": "helmet hanger",
    "kabel": "cable",
    "kedja": "chain",
    "kedjan": "chain",
    "kedje": "chain",
    ...
    "praglad": "embossed",
    "radera": "delete",
    "reservdel": "replacement part",
    "reservdelar": "replacement parts",
    "rektangel": "rectangle",
    "ribba": "rib",
    "ribbor": "ribs",
    "rotera": "rotate",
    ...
    "snusdosa": "snus can",
    "snusdose": "snus can",
    "snusdosahallare": "snus can holder",
    "snusdosehallare": "snus can holder",
    "staende": "vertical",
    "stativ": "stand",
    "stall": "stand",
    "stallet": "stand",
