...
const frontendBucket = new aws.s3.Bucket("cadio-frontend", {
  forceDestroy: true,
  website: {
...
const exportsBucket = new aws.s3.Bucket("cadio-exports", {
  forceDestroy: true,
  lifecycleRules: [
    {
      id: "expire-exports",
...
export const frontendWebsiteUrl = frontendBucket.websiteEndpoint.apply(
  (ep) => `http://${ep}`,
);
